...
**HackRF를 활용한 GPS Spooiing 및 Jamming 실험**을 수행하여 드론의 비행에 미치는 영향을 연구하는 것을 목표로 한다.
...
### 실험 개요
**HackRF와 GPS-SDR-SIM을 이용하여 PX4 드론의 GPS 신호를 변조(Spoofing)하거나 방해(Jamming)하여, 비행 데이터에 미치는 영향을 분석하는 실험을 수행한다.**

### 실험 목표
**GPS Spoofing**: 드론의 위치 정보를 변조하여 의도된 좌표로 이동하도록 유도  
**GPS Jamming**: 드론이 GPS 신호를 수신하지 못하게 하여 비행 제어 방해  
